              ...
              <div class="col-md-6">
                ...
                <div class="row">
                  <div id="myTabContent" class="tab-content">
                      ...
                      <h3 class="judul2">IMPORTANT !</h3>
                      <pre>Silahkan Klik pada lantai di peta sebelah untuk mendapatkan
informasi tentang parkiran nya.</pre>
        					  </div>
                          ...
                          while ($hasil1a = mysqli_fetch_array($show_map1)) {
                            ...
                            if ($x==0 || $x%10==0) {
                              ...
                              if ($hasil1a['status_ruang']!="kosong") {
                                echo '<td class="bg-danger">'.$hasil1a['id_ruang']."</td>";
                              }else {
                                echo '<td class="bg-success">'.$hasil1a['id_ruang']."</td>";
                              }

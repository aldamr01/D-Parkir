<?php
  ...
  }elseif (isset($_POST['mobiledit'])) {
    $no_plat   = $_POST['no_plat'];
    $status_mobil    = $_POST['status'];
    if(ubahmobil($status_mobil,$no_plat)){
      header("Location: index.php");
    }else{
      echo "gagal";
      header("Location: index.php");
      ...
      <div class="body" style="margin-top:40px">
        <div class="container">
          <section id="check">
            <div class="row">
              <div class="col-md-12">
                <h2 class="judul" align="center">Check Availability Room</h2>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <div class="row">
                  <div id="myTabContent" class="tab-content">
                      ...
                      <br>
                      <h3 class="judul2">keluarkan Mobil </h3>
                      <table class="table table-responsive table-striped table-bordered">
                      <thead class="bg-success">
                        <tr>
                          <td>Plat Nomor</td>
                      ...
                      <tbody>
                        <form class="" name="mobilkeluar" action="hapusmobil.php" method="post">
                        <tr>
                          <td align="center">
                            <select class="form-control" name="no_plat">
                              <?php
                                while($hasil = mysqli_fetch_assoc($showmobil)){
                               ?>
                               <option  value="<?=$hasil['no_plat'];?>"><?=$hasil['no_plat'];?></option>
                             <?php } ?>
                            </select>
                          </td>
                          <td align="center">
                            <button type="submit" class="btn btn-danger" name="mobilkeluar">Keluarkan</button>
                          </td>
                        </tr>
                      </form>
                      </tbody>
                      ...
                      <tbody>
                        <form class="" name="mobiledit" action="index.php" method="post">
                        <tr>
                          <td align="center">
                            <select class="form-control" name="no_plat">
                              <?php
                                while($hasil2 = mysqli_fetch_assoc($showmobil2)){
                               ?>
                               <option  value="<?=$hasil2['no_plat'];?>"><?=$hasil2['no_plat'];?></option>
                             <?php } ?>
                            </select>
                          </td>
                          <td>
                            <select class="form-control" name="status">
                              <option value="on_room">On Room</option>
                              <option value="on_area">On Area</option>
                            </select>
                          </td>
                          <td align="center">
                            <button type="submit" class="btn btn-warning" name="mobiledit">Ubah data</button>
                          </td>
                        </tr>
                      </form>
                      </tbody>
